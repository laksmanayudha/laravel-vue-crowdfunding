...
var render = function render() {
  ...
  return _c("div", [_vm.campaign.id ? _c("v-card", [_c("v-img", {
  ...
  }, [_vm._v(" Rp " + _vm._s(_vm.campaign.collected.toLocaleString("id-ID")))])]), _vm._v(" "), _c("tr", [_c("td", [_c("v-icon", [_vm._v("mdi-cash")]), _vm._v(" Dibutuhkan")], 1), _vm._v(" "), _c("td", {
    staticClass: "orange--text"
  }, [_vm._v(" Rp " + _vm._s(_vm.campaign.required.toLocaleString("id-ID")))])])])]), _vm._v("\r\n                Description: "), _c("br"), _vm._v("\r\n                " + _vm._s(_vm.campaign.description) + "\r\n            ")], 1), _vm._v(" "), _c("v-card-actions", [_c("v-btn", {
    attrs: {
      block: "",
      color: "primary",
  ...
  }, [_c("v-icon", [_vm._v("mdi-money")]), _vm._v("  \r\n                    DONATE\r\n                ")], 1)], 1)], 1) : _vm._e()], 1);
};
