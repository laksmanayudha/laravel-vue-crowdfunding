...
var render = function render() {
  ...
  })], 1), _vm._v(" "), _c("v-card-actions", [_c("v-icon", [_vm._v("mdi-cash")]), _vm._v(" "), _c("span", [_vm._v(" Rp " + _vm._s(_vm.campaign.required.toLocaleString("id-ID")) + " ")]), _vm._v(" "), _c("v-spacer"), _vm._v(" "), _c("span", [_vm._v(_vm._s(_vm.progress) + "%")])], 1)], 1)], 1);
};
